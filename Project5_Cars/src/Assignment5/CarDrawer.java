...
// create the 4 points connecting the windshields and roof
        ...
        Point2D.Double r2 = new Point2D.Double(xCar + WIDTH_CAR / 3, yCar);
        Point2D.Double r3 = new Point2D.Double(xCar + (2 * WIDTH_CAR) / 3, yCar);
        Point2D.Double r2_2 = new Point2D.Double(xCar + WIDTH_CAR / 3, yCar+1);
        Point2D.Double r3_2 = new Point2D.Double(xCar + (2 * WIDTH_CAR) / 3, yCar+1);
        Point2D.Double r2_3 = new Point2D.Double(xCar + WIDTH_CAR / 3, yCar-1);
        Point2D.Double r3_3 = new Point2D.Double(xCar + (2 * WIDTH_CAR) / 3, yCar-1);
        Point2D.Double r4 = new Point2D.Double(xCar + (5 * WIDTH_CAR) / 6, yCar + (5 * HEIGHT_CAR) / 16);
...
// create the windshields and roof of the car
        ...
        Line2D.Double rearWindshield = new Line2D.Double(r3, r4);
        Line2D.Double roofTop = new Line2D.Double(r2, r3);
        Line2D.Double roofTop2 = new Line2D.Double(r2_2, r3_2);
        Line2D.Double roofTop3 = new Line2D.Double(r2_3, r3_3);
